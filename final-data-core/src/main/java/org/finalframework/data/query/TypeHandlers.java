...
public final class TypeHandlers {
    ...
    public static Class<? extends TypeHandler<?>> findTypeHandler(final Property property) {
        if (property.isAnnotationPresent(org.finalframework.data.annotation.TypeHandler.class)) {
            return property.getRequiredAnnotation(org.finalframework.data.annotation.TypeHandler.class).value();
        }
