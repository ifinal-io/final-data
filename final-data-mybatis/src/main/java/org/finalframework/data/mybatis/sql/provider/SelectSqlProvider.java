 ...
 * @author likly
 * @version 1.0.0
 * @see org.finalframework.data.mybatis.mapper.AbsMapper#select(String, Class, Collection, IQuery)
 * @see org.finalframework.data.mybatis.mapper.AbsMapper#selectOne(String, Class, Serializable, IQuery)
 * @since 1.0.0
 */
