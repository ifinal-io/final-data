...
import org.finalframework.data.mybatis.sql.ScriptMapperHelper;
import org.finalframework.data.query.DefaultQEntityFactory;
import org.finalframework.query.QEntity;
import org.finalframework.query.QProperty;
import org.finalframework.util.Asserts;
import org.finalframework.velocity.Velocities;
 ...
 * @author likly
 * @version 1.0.0
 * @see org.finalframework.data.mybatis.mapper.AbsMapper#insert(String, Class, boolean, Collection)
 * @see org.finalframework.data.mybatis.mapper.AbsMapper#replace(String, Class, Collection)
 * @see org.finalframework.data.mybatis.mapper.AbsMapper#save(String, Class, Collection)
 * @since 1.0.0
 */
