 ...
 * <pre class="code">
 * &#64;PutMapping("/yn")
 * public int yn(&#64;RequestParam Long id, &#64;RequestParam YN yn){
...
public class YN2RestControllerMethodProvider implements RestControllerMethodProvider {
    ...
    public MethodSpec provide(Class<?> clazz, String service) {
        ...
        return MethodSpec.methodBuilder("yn")
